  ...
  return (
    <section className='ls-hero'>
      ...
      <div className='ls-hero-content'>
        ...
        <p>Beautiful rooms, effortless booking, and considered hospitality—curated for the way you want to travel.</p>
        <div className='ls-hero-actions'><Link href='/rooms' className='ls-btn ls-btn-gold'>Explore rooms <span>→</span></Link><Link href='/about' className='ls-btn ls-btn-ghost'>Discover LuxeStay</Link></div>
      </div>
