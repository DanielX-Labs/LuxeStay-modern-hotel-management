...
function Main() {
  ...
  useEffect(() => {
    switch (selectedKeys) {
      case '1': {
        window.document.title = 'LuxeStay - Dashboard';
        break;
      }
      case '2': {
        window.document.title = 'LuxeStay - Users';
        break;
      }
      case '3': {
        window.document.title = 'LuxeStay - Hotel Rooms';
        break;
      }
      case '4': {
        window.document.title = 'LuxeStay - Booking Orders';
        break;
      }
      case '5': {
        window.document.title = 'LuxeStay - Profile';
        break;
      }
      case '6': {
        window.document.title = 'LuxeStay - Logout';
        break;
      }
      default: {
        window.document.title = 'LuxeStay - Dashboard';
    ...
    <Layout className='w-full h-screen'>
      ...
      <Layout>
        ...
        <Footer className='text-center font-text-font font-medium '>
          &copy;{new Date().getFullYear()} LuxeStay - Designed with
          {' '}
          <a
