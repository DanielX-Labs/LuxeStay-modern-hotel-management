    ...
    if (fullName && phone && gender && dob && address) {
      ...
      res.status(200).json(successResponse(
        ...
        'User info updated successful',
        {
          ...
          // avatar: process.env.API_URL + updatedUser.avatar,
...
exports.getUsersList = async (req, res) => {
  try {
    ...
    const mappedUsers = findUsers?.map((data) => ({
      ...
      email: data.email,
      phone: data.phone,
      // avatar: process.env.API_URL + data.avatar,
      avatar: data.avatar,
      gender: data.gender,
      dob: data.dob,
  ...
  try {
    ...
    res.status(200).json(successResponse(
      ...
      'User blocked successful',
      {
        ...
        // avatar: process.env.API_URL + blockedUser.avatar,
  ...
  try {
    ...
    res.status(200).json(successResponse(
      ...
      'User unblocked successful',
      {
        ...
        // avatar: process.env.API_URL + unblockedUser.avatar,
